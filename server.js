...
- ${finish === "matte" ? "Matte finish: no shine, no reflection, velvety flat surface" : ""}${finish === "glossy" ? "Glossy finish: high shine, wet-look, mirror-like reflection" : ""}${finish === "shimmer" ? "Shimmer/pearl finish: subtle sparkle, pearlescent sheen" : ""}${finish === "glitter" ? "Glitter finish: visible glitter particles throughout the color" : ""}${finish === "chrome" ? "Chrome/metallic finish: mirror-like metallic reflection, liquid metal look" : ""}${finish === "syrup" ? "Syrup nail style: translucent glossy gel nails, soft gradient color, glassy finish, jelly texture, natural light reflection. Korean nail design, minimal, clean, soft pastel tones, natural aesthetic. VERY translucent and sheer — the natural nail and skin underneath must be clearly visible through the color. Think tinted glass or colored cellophane. Macro shot quality, ultra detailed, soft lighting, natural skin tone, photorealistic." : ""}${finish === "magnet" ? "Magnetic nail design: cat eye effect, shimmering metallic particles, reflective light line, glossy gel nails, dynamic light reflection. Sparkling particles, depth effect, moving light reflection, glossy finish, high shine, luminous. Macro shot quality, close-up nails, soft lighting, natural skin tone, ultra detailed, photorealistic." : ""}
- ONLY modify nails — keep everything else unchanged
- Keep original composition, do not crop or zoom
